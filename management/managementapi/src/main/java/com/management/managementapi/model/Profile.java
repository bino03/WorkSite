 ...
 */
@Entity
@Table(name = "profile", schema = "worksite")
public class Profile extends BaseEntity {
    ...
    @Column(name = "account_status", columnDefinition = "worksite.account_status_enum", nullable = false)
    private AccountStatus accountStatus = AccountStatus.unlocked;

    @Enumerated(EnumType.STRING)
    @JdbcTypeCode(SqlTypes.NAMED_ENUM)
    @Column(name = "role", columnDefinition = "worksite.role_enum", nullable = false)
