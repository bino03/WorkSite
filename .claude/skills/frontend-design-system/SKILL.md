...
description: React component patterns for the Worksite Backoffice — folder structure (create/edit/view), naming conventions, React Hook Form + Zod forms, service layer, Drawer pattern, local/Context state (no Zustand in this project), Tailwind + Ant Design styling. Use when building any React component in this project.
---
